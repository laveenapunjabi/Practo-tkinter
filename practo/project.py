...
cursor.execute(" INSERT INTO laveena(username, password) values(?,?)",('lavina','1234'))
...
btn14=Button(plan,text="Buy Plan",command= lambda : plans1(1,'Basic Plans',username.get()),font=("arial",18,"bold"),bd = 6, bg="black", fg= "white")
...
btn15=Button(plan,text="Buy Plan",command= lambda : plans1(2,'popular',username.get()),font=("arial",18,"bold"), bd = 6, bg="black", fg= "white")
